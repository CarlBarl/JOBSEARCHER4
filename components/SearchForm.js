        ...
        <div className="flex-1">
          ...
          <div className="relative">
            ...
            <input
              id="q"
              type="text"
              className="block w-full pl-11 pr-4 py-3.5 bg-secondary-50 border border-gray-200 rounded-lg shadow-soft placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors text-gray-800" // Added text-gray-800 here
